      ...
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Socials">
          <div className="flex flex-col space-y-4 text-sm">
            ...
            <HoveredLink href="https://www.instagram.com/iveer09" target="_blank">Instagram</HoveredLink>
            <HoveredLink href="https://www.linkedin.com/in/veer-singh-6bb56224a/" target="_blank">Linkedin</HoveredLink>
            <HoveredLink href="https://x.com/iz_veer007" target="_blank">Twitter</HoveredLink>
          </div>
        </MenuItem>
      </Menu>
      <ModeToggle />
